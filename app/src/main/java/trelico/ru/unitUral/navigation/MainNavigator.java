...
public class MainNavigator implements Navigator {
    ...
    protected void activityForward(Forward command) {
        ru.terrakok.cicerone.android.support.SupportAppScreen screen = (ru.terrakok.cicerone.android.support.SupportAppScreen) command.getScreen();
    ...
    private void checkAndStartActivity(ru.terrakok.cicerone.android.support.SupportAppScreen screen, Intent activityIntent, Bundle options) {
     ...
     */
    protected void unexistingActivity(ru.terrakok.cicerone.android.support.SupportAppScreen screen, Intent activityIntent) {
